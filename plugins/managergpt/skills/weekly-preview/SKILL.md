...
Help them protect the time when useful: how they'll communicate a Deep Work block, what criteria may override it, and their "sayno" response to requests that don't meet the bar. Offer this when they struggle to protect time — not every week.
